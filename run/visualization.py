...
def fault_impact_heatmap_cost(df_combined, configs):
    ...
    df_monthly = df_combined.groupby(['Month'])[["baseline_elec_{}".format(configs["sensor_unit_elec"]),"baseline_ng_{}".format(configs["sensor_unit_ng"]),'diff_elec_cost_$','diff_ng_cost_$']].sum()
